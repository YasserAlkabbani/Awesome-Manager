...
@Composable
fun BottomSheetPasswordRestored(
//    passwordRested: com.awesome.manager.core.data.model.actions.bottomsheet.BottomSheetContent.PasswordRested
) {
...
//            positive = true, onClick = passwordRested.dismiss
//        ),
