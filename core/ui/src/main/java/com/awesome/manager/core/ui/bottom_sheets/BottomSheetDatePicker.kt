...
fun BottomSheetDatePicker(
    pickDate: BottomSheetContent.PickDate
) {
    val state = rememberDatePickerState(initialDisplayedMonthMillis = pickDate.initTime)
    Column {
        Row(
...
fun BottomSheetDatePackerPreview() {
    BottomSheetDatePicker(BottomSheetContent.PickDate(0, {}, {}))
}
