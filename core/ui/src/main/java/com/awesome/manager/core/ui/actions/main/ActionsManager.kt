...
abstract class ActionsManager : NavigationState, DynamicFabState, BottomSheetState, ErrorState,
    ...
    fun sendMainAction(mainAction: MainAction) = _mainAction.update { mainAction }
    fun doneMainAction() = _mainAction.update { null }

    override fun NavigationAction.applyAction() = sendMainAction(this)
    override fun DynamicFabAction.applyAction() = sendMainAction(this)
    override fun BottomSheetAction.applyAction() = sendMainAction(this)
    override fun PickerAction.applyAction() = sendMainAction(this)
    override fun ErrorAction.applyAction() = sendMainAction(this)
