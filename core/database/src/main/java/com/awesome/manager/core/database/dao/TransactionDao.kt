...
//                "(SELECT code FROM currencies WHERE accounts.currency_id == currencies.currency_id" + ") AS currency_code ," +
//                "(SELECT symbol FROM currencies WHERE accounts.currency_id == currencies.currency_id) AS currency_symbol " +
//                "FROM transactions " +
//                "LEFT JOIN " +
